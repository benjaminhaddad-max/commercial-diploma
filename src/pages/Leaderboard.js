  ...
  app.innerHTML = `
    <div class="dashboard-layout">
      ...
      <div class="dashboard-main">
        ${renderHeader('Classement Équipe', { activePeriod: currentPeriod })}
        <div class="dashboard-content" id="leaderboardContent">
